...
class CityScapesDataset2cWeighted(BaseDataSet):
    def __init__(self, mode='fine', **kwargs):
        self.num_classes = 2
        self.mode = mode
        self.palette = palette.CityScpates_palette
        self.id_to_trainId = ID_TO_TRAINID
        super(CityScapesDataset2cWeighted, self).__init__(**kwargs)
...
class CityScapes2cWeighted(BaseDataLoader):
    def __init__(self, data_dir, batch_size, split, crop_size=None, base_size=None, scale=True, num_workers=1, mode='fine', val=False,
        ...
        self.dataset = CityScapesDataset2cWeighted(mode=mode, **kwargs)
        super(CityScapes2cWeighted, self).__init__(self.dataset, batch_size, shuffle, num_workers, val_split)
